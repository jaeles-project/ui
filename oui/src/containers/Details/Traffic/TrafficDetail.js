...
class PayloadDetail extends Component {
  ...
  handleChange(json_body) {
    ...
    this.props.axiosStore.instance
      .patch(`/rest/v1/traffic/${id}/`, json_body)
      .then(response => {
                ...
                <div className="bx--col-md-4 bx--col-lg-16">
                  <h1 className="landing-page__heading">
                    <Breadcrumb className="some-class" noTrailingSlash={false}>
                      <BreadcrumbItem>
                        <a href="/#/traffic">HTTP History</a>
                      </BreadcrumbItem>
                      <BreadcrumbItem isCurrentPage>
                        <a href="/#/traffic">Detail </a>
                      </BreadcrumbItem>
                      <BreadcrumbItem isCurrentPage>
                        <a href={`/#/traffic/${rid}/detail`}>{rid}</a>
                      </BreadcrumbItem>
                    </Breadcrumb>
                  </h1>
                  <hr />
