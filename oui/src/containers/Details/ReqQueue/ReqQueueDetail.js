...
class PayloadDetail extends Component {
  ...
  getBeautify(id) {
    this.props.axiosStore.instance
      .get(`rest/v1/beautify/req/${id}/?source=queue`)
      .then(response => {
                ...
                <div className="bx--col-md-4 bx--col-lg-16">
                  <h1 className="landing-page__heading">
                    <Breadcrumb
                      ...
                      <BreadcrumbItem>
                        <a href="/#/reqQueue">Request Queue Summary</a>
                      </BreadcrumbItem>
                      <BreadcrumbItem isCurrentPage>
                        <a href="/#/reqQueue">Detail </a>
                      </BreadcrumbItem>
                      <BreadcrumbItem isCurrentPage>
                        <a href={`/#/reqQueue/${rid}/detail`}>{rid}</a>
                      </BreadcrumbItem>
                    </Breadcrumb>
                  </h1>
                  <hr />
